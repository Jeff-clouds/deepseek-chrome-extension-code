...
__export(main_exports, {
  default: () => MarkdownImageGenerator
});
...
var MarkdownImageGenerator = class extends import_obsidian.Plugin {
  async onload() {
    ...
    this.registerEvent(
      this.app.workspace.on("editor-menu", (menu, editor, view) => {
        menu.addItem((item) => {
          item.setTitle("\u751F\u6210 Markdown \u56FE\u7247").setIcon("image").onClick(() => {
            new ImageGeneratorModal(this.app, this, editor).open();
          });
        });
      })
...
var ImageGeneratorModal = class extends import_obsidian.Modal {
  ...
  onOpen() {
    ...
    import_obsidian2.MarkdownRenderer.renderMarkdown(markdownContent, contentDiv, "", this.plugin);
    ...
    generateButton.addEventListener("click", async () => {
      try {
        const canvas = await (0, import_html2canvas.default)(previewContainer);
        const image = canvas.toDataURL("image/png");
        const link = document.createElement("a");
        link.download = "markdown-image.png";
        link.href = image;
        link.click();
        new import_obsidian.Notice("\u56FE\u7247\u5DF2\u751F\u6210\uFF01");
      } catch (error) {
        new import_obsidian.Notice("\u751F\u6210\u56FE\u7247\u65F6\u51FA\u9519\uFF1A" + error.message);
      }
    });
  }
  onClose() {
...
var MarkdownImageGeneratorSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl).setName("\u56FE\u7247\u5BBD\u5EA6").setDesc("\u8BBE\u7F6E\u751F\u6210\u56FE\u7247\u7684\u5BBD\u5EA6\uFF08\u50CF\u7D20\uFF09\uFF0C\u5EFA\u8BAE\u8303\u56F4\uFF1A400-2000").addText((text) => text.setPlaceholder("\u8F93\u5165\u5BBD\u5EA6").setValue(this.plugin.settings.width.toString()).onChange(async (value) => {
      ...
      } else if (numValue > 2e3) {
        text.setValue("2000");
        this.plugin.settings.width = 2e3;
      } else {
        this.plugin.settings.width = numValue;
      }
      await this.plugin.saveSettings();
    }));
    new import_obsidian.Setting(containerEl).setName("\u8868\u60C5\u7B26\u53F7").setDesc("\u8BBE\u7F6E\u9876\u90E8\u663E\u793A\u7684\u8868\u60C5\u7B26\u53F7").addText((text) => text.setPlaceholder("\u8F93\u5165\u8868\u60C5\u7B26\u53F7").setValue(this.plugin.settings.emoji).onChange(async (value) => {
      this.plugin.settings.emoji = value;
      await this.plugin.saveSettings();
    }));
    new import_obsidian.Setting(containerEl).setName("\u6C34\u5370\u6587\u672C").setDesc("\u8BBE\u7F6E\u56FE\u7247\u5E95\u90E8\u7684\u6C34\u5370\u6587\u672C").addText((text) => text.setPlaceholder("\u8F93\u5165\u6C34\u5370\u6587\u672C").setValue(this.plugin.settings.watermark).onChange(async (value) => {
